...
<div class="main-header">
    ...
    <p>Tác giả: Đặng Văn Tuấn - Trường PTDTBT Tiểu học Kiên Đài - ĐT: 0385 536 835</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Đặng Văn Tuấn - Trường PTDTBT Tiểu học Kiên Đài - ĐT: 0385 538 835</div>", unsafe_allow_html=True)
